package ru.mirea.kurbanovaad.httpurlconnection;
...
import ru.mirea.kurbanovaad.httpurlconnection.databinding.ActivityMainBinding;
...
//            binding.weatherView.setText(result);
            ...
            try {
                ...
                binding.textView.setText("Страна: " + responseJson.getString("country"));
                binding.textView2.setText("Регион: " + responseJson.getString("region"));
                binding.textView3.setText("Город: " + responseJson.getString("city"));
        ...
        private class RequestWeatherInfo extends DownloadPageTask {
            ...
            protected void onPostExecute(String result) {
                ...
                try {
                    ...
                    binding.textView4.setText("Погода: \n" +
